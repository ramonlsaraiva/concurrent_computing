        ...
        public void funcDesenha()
        {
            ...
            for (int i = qtdAvioes-1; i >= 0; i--)
            {
                if (aviaoAtivo[i])
                {
                    ...
                    PointF[] pointsAviao = new PointF[] {
                        new PointF(xAviao[i],yAviao[i]),
                        new PointF(xAviao[i]-40,yAviao[i]),
                        new PointF(xAviao[i]-40,yAviao[i]+40),
                        new PointF(xAviao[i],yAviao[i]+40)
                    };

                    PointF[] fundoTexto = new PointF[] {
                        new PointF(xAviao[i],yAviao[i]+10),
                        new PointF(xAviao[i]-40,yAviao[i]+10),
                        new PointF(xAviao[i]-40,yAviao[i]+30),
                        new PointF(xAviao[i],yAviao[i]+30)
                    };
                    ...
                    objDesenha.DrawString((i + 1).ToString("D4"), varFont, brushTexto, xAviao[i]-40, yAviao[i]+10);
